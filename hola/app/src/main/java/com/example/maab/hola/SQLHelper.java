...
public class SQLHelper {
	...
	public static ArrayList<Event> constructEvent(ResultSet rs) throws SQLException{
		...
		ArrayList<String> guestsEmail = new ArrayList<String>();
		...
		while(rs.next()){
			...
			date 		= getDateOfBirth(rs.getString("dateAndTime"));
			
			guestsEmail = emailsToArrayList(rs.getString("guests"));
	...
	public static ArrayList<User> constructUser(ResultSet rs) throws SQLException{
		...
		while(rs.next()){
			...
			dateOfBirth 	= SQLHelper.getDateOfBirth(rs.getString("dateOfBirth"));
			
			eventEmails		= SQLHelper.emailsToArrayList(rs.getString("events"));
